...
class Captcha
{
    ...
    {
        if (count($color) >= 3) $this->color = $color;
        return $this;
    }
    ...
    private function build()
    {
        ...
        for($i=0;$i<strlen($this->str);$i++){
            ...
            $y = rand($_y - 5, $_y + 5);
            // 字体库
            imagettftext($image, $this->fontSize, 0,  $x, $y, $fontcolor, $this->font, $fontcontent);
        }
        //添加干扰点
        ...
        for($i=0; $i<$this->lineNum; $i++) {
            ...
            imageline($image,rand(5,$this->width-5),rand(5,$this->height-5),rand(5,$this->width-5),rand(5,$this->height-5),$linecolor);
        }
        $this->image = $image;
    }
